...
function M.get(palette, config)
  ...
  vim.tbl_extend("force", groups, base.get(palette, config))
  vim.tbl_extend("force", groups, syntax.get(palette, config))
  vim.tbl_extend("force", groups, lsp.get(palette, config))
  vim.tbl_extend("force", groups, treesitter.get(palette, config))

  local plugins = require("mayukai.groups.plugins")
  local plugin_hl = plugins.get(palette, config)
  vim.tbl_extend("force", groups, plugin_hl)
